...
def eval_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(
        args.model_path, args.model_base, model_name,device='mps',device_map='mps'
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/Users/aprilfq/PycharmProjects/llm-param-checkpoints/llava-1.5-7b")
    parser.add_argument("--model-base", type=str, default=None)
    parser.add_argument("--image-file", type=str, default='/Users/aprilfq/PycharmProjects/benchmark/coco-val2014/COCO_val2014_000000081561.jpg')

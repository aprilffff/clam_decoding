    ...
    **model_kwargs,
    ...
    while True:
        ...
        if use_cd:
            ...
            cd_probs = nn.functional.softmax(cd_logits, dim=-1)#FIXME: delete
            next_tokens = torch.multinomial(cd_probs, num_samples=1).squeeze(1)#FIXME: use greedy search logic
        else:
